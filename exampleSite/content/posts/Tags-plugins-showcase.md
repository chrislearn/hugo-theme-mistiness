...
This post is used to show how tag plugins are displayed. See [docs](https://github.com/kakawait/hugo-mistiness-theme/blob/master/docs/user.md#tags) for more info.
<!--more-->
...
Read documentation to know how to use [Alert tag](https://github.com/kakawait/hugo-mistiness-theme/blob/master/docs/user.md#alert)
...
Read documentation to know how to use [Image tag](https://github.com/kakawait/hugo-mistiness-theme/blob/master/docs/user.md#image)
...
Read documentation to know how to use [Highlight text tag](https://github.com/kakawait/hugo-mistiness-theme/blob/master/docs/user.md#highlight-text)
...
Read documentation to know how to use [Tabbed code block](https://github.com/kakawait/hugo-mistiness-theme/blob/master/docs/user.md#tabbed-code-block)
...
Read documentation to know how to use [Wide image tag](https://github.com/kakawait/hugo-mistiness-theme/blob/master/docs/user.md#wide-image)
